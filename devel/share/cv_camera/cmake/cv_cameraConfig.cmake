...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/robot/Projects/Image_Processing/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/robot/Projects/Image_Processing/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/robot/Projects/Image_Processing/install)
...
if(NOT "/home/robot/Projects/Image_Processing/src/cv_camera/include " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/Projects/Image_Processing/src/cv_camera/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/Projects/Image_Processing/src/cv_camera/${idir}'.  Ask the maintainer 'Takashi Ogura <t.ogura@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robot/Projects/Image_Processing/devel/lib;/home/robot/Projects/Tactile-Pose-Estimation/devel/lib;/home/robot/Projects/AdaptiveFingertip/devel/lib;/home/robot/Projects/Kinba-Project-16/devel/lib;/opt/ros/indigo/lib)
