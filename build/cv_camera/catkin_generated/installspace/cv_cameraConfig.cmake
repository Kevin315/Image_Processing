...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/Projects/Image_Processing/install/${idir}'.  Ask the maintainer 'Takashi Ogura <t.ogura@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robot/Projects/Image_Processing/install/lib;/home/robot/Projects/Tactile-Pose-Estimation/devel/lib;/home/robot/Projects/AdaptiveFingertip/devel/lib;/home/robot/Projects/Kinba-Project-16/devel/lib;/opt/ros/indigo/lib)
